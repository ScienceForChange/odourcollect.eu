...
class PointOfInterest extends Model implements Auditable
{
     ...
     */
    protected $fillable = [
        'id', 'id_odor_type', 'id_admin', 'name', 'slug', 'address', 'address__mapbox_id', 'postal_code', 'postal_code__mapbox_id', 'place', 'place__mapbox_id', 'region', 'region__mapbox_id', 'country', 'country__mapbox_id', 'latitude', 'longitude', 'published_at'
    ];
